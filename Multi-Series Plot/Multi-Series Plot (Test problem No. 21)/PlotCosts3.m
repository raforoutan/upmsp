...
%         x=q(1,:);
        ...
        plot(y,z,'or','Markersize',5, 'marker' , 'o' , 'markeredgecolor','red' , 'markerfacecolor','yellow');
...
%         x=qqq1(1,:);
        ...
        z=qqq1(3,:);
        %plot3(x,y,z,'or','Markersize',15, 'marker' , '^' ,'markerfacecolor','green' , 'markeredgecolor','blue');
        plot(y,z,'or','Markersize',5, 'marker' , 'o' , 'markeredgecolor','#7E2F8E' , 'markerfacecolor','magenta');
%       plot3(EPC(1,:),EPC(2,:),EPC(3,:),'or','Markersize',5,'markerfacecolor','y');
        title(['Iteration =' 100]);
        xlabel('f_2(x)');
        ylabel('f_3(x)'); 
...
%         x=qqq2(1,:);
        ...
        z=qqq2(3,:);
        %plot3(x,y,z,'or','Markersize',15, 'marker' , '^' ,'markerfacecolor','green' , 'markeredgecolor','blue');
        plot(y,z,'or','Markersize',5, 'marker' , 'o' , 'markeredgecolor','blue' , 'markerfacecolor','cyan');
%       plot3(EPC(1,:),EPC(2,:),EPC(3,:),'or','Markersize',5,'markerfacecolor','y');
        title(['Iteration =' 100]);
        xlabel('f_2(x)');
        ylabel('f_3(x)'); 
